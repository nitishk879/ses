...
<head>
    ...
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
    <link rel="shortcut icon" type="image/x-icon" href="https://wphtml.com/html/tf/duralux-demo/assets/images/favicon.ico" />
    <!--! END: Favicon-->
    <!--! BEGIN: Bootstrap CSS-->
    <link rel="stylesheet" type="text/css" href="https://wphtml.com/html/tf/duralux-demo/assets/css/bootstrap.min.css" />
    <!--! END: Bootstrap CSS-->
    <!--! BEGIN: Vendors CSS-->
    <link rel="stylesheet" type="text/css" href="https://wphtml.com/html/tf/duralux-demo/assets/vendors/css/vendors.min.css" />
    <link rel="stylesheet" type="text/css" href="https://wphtml.com/html/tf/duralux-demo/assets/vendors/css/daterangepicker.min.css" />
    <!--! END: Vendors CSS-->
    <!--! BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="https://wphtml.com/html/tf/duralux-demo/assets/css/theme.min.css" />
    <!--! END: Custom CSS-->
...
<!--! ================================================================ !-->
<!--! BEGIN: Vendors JS !-->
<script src="https://wphtml.com/html/tf/duralux-demo/assets/vendors/js/vendors.min.js"></script>
<!-- vendors.min.js {always must need to be top} -->
<script src="https://wphtml.com/html/tf/duralux-demo/assets/vendors/js/daterangepicker.min.js"></script>
<script src="https://wphtml.com/html/tf/duralux-demo/assets/vendors/js/apexcharts.min.js"></script>
<script src="https://wphtml.com/html/tf/duralux-demo/assets/vendors/js/circle-progress.min.js"></script>
<!--! END: Vendors JS !-->
<!--! BEGIN: Apps Init  !-->
<script src="https://wphtml.com/html/tf/duralux-demo/assets/js/common-init.min.js"></script>
<script src="https://wphtml.com/html/tf/duralux-demo/assets/js/dashboard-init.min.js"></script>
<!--! END: Apps Init !-->
<!--! BEGIN: Theme Customizer  !-->
<script src="https://wphtml.com/html/tf/duralux-demo/assets/js/theme-customizer-init.min.js"></script>
<!--! END: Theme Customizer !-->
</body>
