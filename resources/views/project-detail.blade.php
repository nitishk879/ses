...
@section('content')
    <div class="container" id="dashboard">
        <div class="row">
                ...
                <div class="row ">
                    <div class="col-md-8">
                        ...
                        <div class="d-flex gap-5 my-2">
                            <div class="mb-2 job-timestamp"><i class="fa-solid fa-calendar-days"></i> Registration: Nov 12, 2021</div>
                            <div class="mb-2 job-timestamp"><i class="fa-solid fa-rotate"></i> Updated on: Nov 12, 2021</div>
                            <div class="mb-2 job-timestamp"><i class="fa-regular fa-hourglass-half"></i> Duration: 3-6 Months</div>
                        </div>
                    ...
                    <div class="col-md-4 pt-5">
                        <img src="{{ asset("images/job-detail-banner.png") }}" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
            <div class="col-md-8 job-detail">
                        ...
                        <div class="col-md-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 align-items-center ms-3">
                                    <h5 class="main-title">Contract Period</h5>
                                    <h4 class="main-sub-title">13 -15 Days</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 align-items-center ms-3">
                                    <h5 class="main-title">MONTHLY SALARY:</h5>
                                    <h4 class="main-sub-title">800k - 900k JPY</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 align-items-center ms-3">
                                    <h5 class="main-title">LOCATION</h5>
                                    <h4 class="main-sub-title">TOKYO, JAPAN</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="job-description gap-3">
                    <h3 class="heading-1">Job Description</h3>
                    ...
                    <div class="skill-required">
                        ...
                        <div class="d-flex gap-3">
                            <a href="" class="skill">Analytic</a>
                            <a href="" class="skill">Development</a>
                            <a href="" class="skill">Coding</a>
                            <a href="" class="skill">Python</a>
                        </div>
                    </div>
                ...
                <div class="job-right-sidebar">
                    ...
                    <div class="requirements">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1 align-items-center ms-3">
                                <h5 class="requirement-title">Project Category</h5>
                                <h4 class="requirement-sub-title">Front end Development</h4>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-3">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 align-items-center ms-3">
                                <h5 class="requirement-title">Status of the Project</h5>
                                <h4 class="requirement-sub-title">Confirmed</h4>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-3">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 align-items-center ms-3">
                                <h5 class="requirement-title">Project Flow</h5>
                                <h4 class="requirement-sub-title">Primary Contractor</h4>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-3">
                            <div class="flex-shrink-0">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1 align-items-center ms-3">
                                <h5 class="requirement-title">Number of Interviews</h5>
        ...
        <div class="row align-items-center similar-projects">
            <div class="col-md-12">
                <h4 class="you-may-like">Projects you may like</h4>
            </div>
            <div class="col-md-4">
                <div class="project-card">
                    ...
                    <div class="project-card-body p-3">
                        ...
                        <span class="project-date">Dec 21st, 2024</span>
                        <h2 class="project-title">Migration Coding Facility</h2>
                        <h6 class="project-budget">Project Budget: <span>JPY 500k-800k/month</span></h6>
                        <p class="project-overview">Integer aliquet pretium consequat. Donec et sapien id leo accumsan pellentesque eget maximus tellus. Duis et est ac leo rhoncus tincidunt vitae vehicula augue.</p>
                        <div class="d-flex gap-3">
                            <h5 class="project-location"><i class="fas fa-location-dot"></i> Japan, Tokyo</h5>
                            <h6 class="project-location">Remote</h6>
                        </div>
                        <div class="d-flex gap-2 my-2">
                            <div class="project-skill"> 3D</div>
                            <div class="project-skill"> Analytics</div>
                            <div class="project-skill"> Python</div>
                            <div class="project-skill more"> 11+</div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <div class="d-flex justify-content-between align-items-center w-100">
                                    ...
                                    <a href="" class="btn btn-theme">View Project</a>
                                </div>
                            </div>
                        </div>
                    </div>
