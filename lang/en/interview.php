...
return [
    ...
    'dashboard' => [
        ...
        'conducted_by' => 'Conducted by bot',
        'conducted_by_generated' => 'none — SES-generated questions',
        'slot_times' => 'Times to offer',
        'slot_times_help' => 'All three are required, and exactly these are offered to the candidate — today included. Times are in :zone and must be in the future.',
        'slot_times_required' => 'Choose all three interview times — the candidate is offered exactly these.',
        ...
        'conversation_reconstructed' => 'No call transcript was stored, so this conversation was rebuilt from the recorded questions and answers. Anything said outside those is missing.',
        'questions_matched' => ':matched of :total planned questions identified',
    ...
    'requirement' => [
        'heading' => 'Requirements from this job description',
        'help' => 'Switch on the ones that are non-negotiable for this client. Candidates are still scored on everything — a must-have decides who qualifies, not what they score.',
        'mandatory_count' => ':count marked must-have',
        'none' => 'No requirements yet. Run matching once and the job description will be read into this list.',
        'stale' => 'no longer in the JD',
        'needs_number' => 'needs a number',
        'years' => 'years',
        'experience_label' => ':years+ years of experience',
        'from_project_form' => 'Required on the project form.',
        'location_label' => 'Works in one of the project locations',
        'budget_label' => 'Monthly rate within ¥:amount',
        'kind' => [
            'skill' => 'Skill',
    ...
    'match_run' => [
        ...
        'open_screen' => 'Open matching screen',
        'to_interviews' => 'Interviews',
        'analyze' => 'Analyze / Match candidates',
        'starting' => 'Starting…',
        'already_running' => 'A matching run is already in progress for this project.',
        'started' => 'Matching started. :count CV(s) are being read; you will be emailed when it finishes.',
        'in_progress' => 'Matching :count candidate(s)… this page updates itself.',
        'failed' => 'The last matching run did not finish: :reason',
        'never_run' => 'Matching has not been run for this project yet.',
        'last_run' => 'Last run :when — :scored candidate(s) scored.',
        'parse_failures' => ':count CV(s) could not be read.',
        'gate_stale' => 'The must-haves changed after these scores were computed. Run matching again to apply them.',
        'no_jd' => 'The job description could not be parsed, so no candidate could be scored.',
        'project_gone' => 'The project was deleted before scoring finished.',
        ...
        'review_help' => 'These candidates clear the score but have a must-have the documents do not answer either way — usually a CV that lists roles without dates, or one that names no languages. They are not rejections.',
        ...
        'empty_never_run' => 'No scores yet. Press “Analyze / Match candidates” to read the CVs.',
        'empty_filter' => 'No candidates in this view. Try lowering the score or switching tab.',

        'mail' => [
            'subject' => ':count candidate(s) matched “:project”',
            'heading' => ':count candidates matched this job description',
            'greeting' => 'Hi :name,',
            'intro' => 'Matching has finished for :project. :count of the :scored candidate(s) scored meet the requirements.',
            'needs_review' => 'A further :count candidate(s) scored well but have a requirement their documents do not answer — they are waiting in the “Needs review” tab.',
            'preview_heading' => 'Top matches',
            'and_more' => '…and :count more.',
            'unnamed' => 'Candidate #:id',
            'cta' => 'View all matches',
            'parse_failures' => 'Note: :count CV(s) could not be read, so those candidates were not scored.',
            'footer' => 'From the dashboard you can select candidates and send them interview times in one go.',
        ],
    ],
    ...
    'evaluation_digest' => [
        'recommendation' => [
            ...
            'maybe_recommended' => 'Borderline',
            'not_recommended' => 'Not recommended',
            'insufficient_data' => 'Too little said to judge',
        ],

        'mail' => [
            'subject' => 'AI interview evaluation completed for :count candidate(s) — :project',
            'heading' => 'The AI interview evaluation has been completed for :count candidate(s)',
            'greeting' => 'Hi :name,',
            'intro' => ':count candidate(s) interviewed for :project have been scored.',
            'recommended' => ':count of them are recommended to take forward.',
            'preview_heading' => 'Highest scoring',
            'and_more' => '…and :count more.',
            'unnamed' => 'Candidate (evaluation #:id)',
            'cta' => 'Review the interviews',
            'footer' => 'Each candidate opens on a single screen with the full conversation, the scores and the evidence behind them.',
        ],
    ],
];
